...
RUN uv pip install --system --no-cache ipykernel==6.30.1
...
ENV HOME=/home/lab PYTHONDONTWRITEBYTECODE=1 VIRTUAL_ENV=/home/lab/.venv UV_PYTHON_DOWNLOADS=never UV_LINK_MODE=copy CLOUDLAB_BASE_PYTHON=/usr/local/bin/python3 CLOUDLAB_TEMPLATE=terminal
